...
export default function DataTableFilterDemo(props) {
    ...
    const getDateItem = () => {
        ...
        let data = {
            ...
            type: 'gstr-purchase-return-report',
        }
                ...
                response['data']['data'].map( data =>
                    {
                        ...
                        {
                            data['igst'] = 0
                            data['cgst'] = data['gt+taxamt']/2
                            data['sgst'] = data['gt+taxamt']/2
                        } else {
                            data['igst'] = data['gt+taxamt']
                            data['cgst'] = 0
                            data['sgst'] = 0
                        }
                    })
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>GSTR Purchase Return Report</h3>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '2300px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock}  rowClassName={rowClass} selectionMode="single"
                                    ...
                                    <Column field="grn"      style={{ width: '120px' }} header="Serial" />
                                    <Column field="cname"     style={{ width: 'auto',textAlign:'left' }} header="Name Of Seller" />
                                    <Column field="tax_no"       style={{ width: '150px',textAlign:'left' }} header="Seller GSTN/UIN" />
                                    <Column field="billno"      style={{ width: '120px' }} header="Invoice No" />
                                    <Column field="bdate"      style={{ width: '150px' }}   header="Invoice Date" />
                                    <Column field="taxp"     style={{ width: '150px',textAlign:'right' }} header="rate Of Tax %" />
                                    <Column field="gt"   style={{ width: '150px',textAlign:'right' }} header="Taxable Value" />
                                    ...
                                    <Column field="taxamt"     style={{ width: '150px',textAlign:'right' }} header="Total Tax" />
                                    <Column field="gt+taxamt"        style={{ width: '200px',textAlign:'right' }} header="Total Amount" />
                                </DataTable>
                            </div>
                        </div>
                    </div>
