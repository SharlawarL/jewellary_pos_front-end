...
export default function DataTableFilterDemo(props) {
    ...
    const getDateItem = () => {
        ...
        let data = {
            ...
            type: 'gstr-purchase-return-summary',
        }
                ...
                response['data']['data'].map( data =>
                    {
                        ...
                        {
                            data['igst'] = 0
                            data['cgst'] = data['net']/2
                            data['sgst'] = data['net']/2
                        } else {
                            data['igst'] = data['net']
                            data['cgst'] = 0
                            data['sgst'] = 0
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>GSTR Purchase Return Summary</h3>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '2000px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock}  rowClassName={rowClass} selectionMode="single"
                                    ...
                                    <Column field="tax_type"       style={{ width: '150px',textAlign:'left' }} header="Tax Type" />
                                    <Column field="taxp"      style={{ width: '120px' }} header="Tax %" />
                                    <Column field="taxamt"     style={{ width: '150px',textAlign:'right' }} header="Tax Amount" />
                                    <Column field="gt"   style={{ width: '150px',textAlign:'right' }} header="Grand Total" />
                                    <Column field="igst"     style={{ width: '150px',textAlign:'right' }} header="IGST" />
                                    <Column field="cgst"     style={{ width: '150px',textAlign:'right' }} header="CGST" />
                                    <Column field="sgst"     style={{ width: '150px',textAlign:'right' }} header="SGST" />
                                    <Column field="net"        style={{ width: '200px',textAlign:'right' }} header="Net Total" />
                                </DataTable>
                            </div>
                        </div>
                    </div>
