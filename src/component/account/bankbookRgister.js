        ...
        return (
            <div className="body">
                ...
                <div className="button_box_small_title">
                    <h3 className="pageTitle">Bank Book Register </h3>
                </div>
                ...
                <div className="continerSmallBox">
                    ...
                    <div className="p-grid">
                        <div className="p-col-12">
                            <div style={fontLebel}>Bank A/c Number</div>
                            <InputText id="username1" placeholder="Enter Bank A/c Number" aria-describedby="username1-help" style={{width:'100%'}} name="bank_account" value={this.state.account} onChange={this.onChange}/>
                        </div>
                    </div>
