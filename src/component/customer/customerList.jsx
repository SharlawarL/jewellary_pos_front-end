...
export default function DataTableFilterDemo(props) {
    ...
    const clickRow = (rowData) => {
        console.log(rowData)
        // alert(rowData.ino)
        setSelectedCustomerNo(rowData.cid)
        setSelectedCustomerList(rowData)
    }
    ...
    const handleDelete = () => {
        let data = {
          ...
          cno : selectedCustomerNo
        }
        customerService.deleteCustomer(data).then((response) =>{
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Customer List</h3>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', marginTop:'10px', overflowX: 'scroll' }}>
                            <div style={{ width: '3000px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock} selectionMode="single" className="p-datatable-striped" globalFilter={globalFilter} emptyMessage="No Search Result." rowClassName={rowClass} onSelectionChange={e => clickRow(e.value)}>
                ...
                <div className="p-grid" style={{ padding: '10px 15px' }}>
                    ...
                    <div className="p-col-1 submitFormButton">
                        {(selectedCustomerNo == null)?'': <Button className="inputData buttonSecondary reportButton" onClick={() => setDisplayBasic(!displayBasic)} variant="contained">
                    ...
                    <div className="p-col-1 submitFormButton">
                        ...
                        to={{
                            pathname: "/customer-master",
                            state: {
                                custNo: selectedCustomerNo,
                                custList: selectedCustomerList,
                                cname : selectedCustomerList['cname'],
                                mobile : selectedCustomerList['mobile'],
                                phone : selectedCustomerList['phone'],
                                email : selectedCustomerList['email'],
                                add1 : selectedCustomerList['add1'],
                                city : selectedCustomerList['city'],
                                nominee : selectedCustomerList['nominee'],
                                state : selectedCustomerList['state'],
                                scode : selectedCustomerList['scode'],
                                category : selectedCustomerList['category'],
                                wdate : selectedCustomerList['wdate'],
                                bdate : selectedCustomerList['bdate'],
                                pincode : selectedCustomerList['pincode'],
                                duedays : selectedCustomerList['duedays'],
                                climit : selectedCustomerList['climit'],
                                tax_no : selectedCustomerList['tax_no'],
                                remarks : selectedCustomerList['remarks'],
                                type: "Update"
                            }
                        }}
