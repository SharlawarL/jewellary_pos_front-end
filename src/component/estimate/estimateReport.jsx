        ...
        salesService.getSalesReport(data).then((response) => {
            ...
            if (response['data']['status'] === 1) {
                ...
                response['data']['data'].map((data)=>{
                    ...
                    data['tweight']    = (Number(data['old_amt'])).toFixed(3)
                    data['make']    = (Number(data['old_amt'])).toFixed(2)
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Estimate Report</h3>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '3500px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock}  rowClassName={rowClass}
                                    ...
                                    {/* <Column field="quans" header="Quntity" />
                                    <Column field="paid" header="Paid" filterMatchMode="contains" />
                ...
                <div className="p-grid" style={{ padding: '10px 15px' }}>
                    ...
                    <div className="p-col-1 submitFormButton">
                        <Button className="inputData buttonSecondary reportButton" variant="contained" onClick={() => onClick('displayBasic')}>
                    ...
                    <div className="p-col-1 submitFormButton">
                        <Link to="/estimate-report" className="Link">
            ...
            <Dialog header="Header" visible={displayBasic} style={{ width: '30vw' }}  onHide={() => onHide('displayBasic')}>
                    ...
                    <div className="p-grid" style={{ width: '102%'}}>
                        ...
                        <div className="p-col-4">
                            <Link to="/estimate-report" className="Link" onHide={() => onHide('displayBasic')}>
