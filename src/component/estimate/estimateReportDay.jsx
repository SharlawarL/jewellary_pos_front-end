...
export default function DataTableFilterDemo(props) {
        ...
        salesService.getSalesReport(data).then((response) => {
            ...
            if (response['data']['status'] === 1) {
                ...
                response['data']['data'].map((data)=>{
                    ...
                    num_bill     = parseFloat(num_bill)   + parseFloat(data['num_bill'])
    ...
    const rowClass = (data) => {
        return {
            'row-accessories': data.day === 'Total'
        }
    }
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Day wise Estimate Report</h3>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '100%', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock} className="p-datatable-striped" globalFilter={globalFilter} emptyMessage="No Search Result." rowClassName={rowClass}>
                                    ...
                                    <Column body={actionBodyTemplate}  style={{ textAlign:'center'}} header="Bill No (From –To)" />
                                    <Column field="num_bill"       style={{ textAlign:'centetr' }} header="No.of Bills" />
                                    <Column field="total"     style={{ textAlign:'right' }} header="Total Sales"    style={{ width: '200px',textAlign:'right' }} header="Total" />
                                </DataTable>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-grid" style={{ padding: '10px 15px' }}>
                    ...
                    <div className="p-col-1 submitFormButton">
                        <Link to="/estimate-day-report" className="Link">
