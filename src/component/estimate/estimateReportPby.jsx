...
export default function DataTableFilterDemo(props) {
    ...
    const [pBy, setPby] = useState(Init.PaymentMod);
    ...
    const getItem = () => {
        ...
        userService.getTotalUser(data).then((response) => {
    ...
    const clickedRow = (event) => {
        setCustomer(event.value.user_name)
        onHide('displayBasic')
    }
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Pay Mode wise Estimate Report</h3>
                        <div className="p-grid-data">
                            ...
                            <div style={{ padding: '10px 10px',width:'100px', textAlign: "right" }}>
                                <div className="p-field">
                                    <label htmlFor="username1" className="p-d-block" style={lebelStyle}>Pay Mode </label>
                                </div>
                            </div>
                            <div className="column-input" style={{ width: '215px' }}>
                                <div className="p-field">
                                <Dropdown value={customer} options={pBy} onChange={(e) => setCustomer(e.value)} optionLabel="name" placeholder="Select a Mode" />
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '3500px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock} rowClassName={rowClass}
                                    ...
                                    <Column field="date_format(dat,'%d/%m/%Y')" header="Date" />
                ...
                <div className="p-grid" style={{ padding: '10px 15px' }}>
                    ...
                    <div className="p-col-1 submitFormButton">
                        <Link to="/estimate-pay-mode-report" className="Link">
                ...
                <div style={{ height: '180px', border: '2px solid #227bce', overflowX: 'scroll' }}>
                    <div style={{ width: 'auto', marginTop: '-5px' }}>
                        <DataTable value={customer_data} selectionMode="single" dataKey="cid" onSelectionChange={clickedRow}>
                            <Column field="branch" style={{ width: '140px' }} header="Branch"></Column>
                            <Column field="user_name" header="Cashier Name"></Column>
                            <Column field="user_level" header="Cashier Level"></Column>
                        </DataTable>
                    </div>
                </div>
            ...
            <Dialog header="Header" visible={displayBasic2} style={{ width: '30vw', padding:'20px', backgroundColor:'white' }}  onHide={() => onHide('displayBasic2')}>
                    ...
                    <div className="p-grid" style={{ width: '102%'}}>
                        ...
                        <div className="p-col-4">
                            <Link to="/estimate-pay-mode-report" className="Link" onHide={() => onHide('displayBasic')}>
