            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Reference Wise Estimate Report</h3>
                        <div className="p-grid-data">
                            ...
                            <div style={{ padding: '10px 10px', textAlign: "right" }}>
                                <div className="p-field">
                                    <label htmlFor="username1" className="p-d-block" style={lebelStyle}>Reference </label>
                                </div>
                            </div>
                            <div className="column-input" style={{ width: '230px' }}>
                                <div className="p-field">
                                    <InputText id="username1" min={date1} name="customer" aria-describedby="username1-help" onChange={(e) => setCustomer(e.target.value)} placeholder="Enter" className="p-d-block InputPrimeBox" value={customer} />
                                </div>
                            </div>
                            ...
                            <div className="column-input" style={{ width: '100px' }}>
                                {/* <div className="p-field">
                ...
                <div className="p-grid" style={{ padding: '10px 15px' }}>
                    ...
                    <div className="p-col-1 submitFormButton">
                        <Link to="/estimate-reference-report" className="Link">
            ...
            <Dialog header="Header" visible={displayBasic2} style={{ width: '30vw', padding:'20px', backgroundColor:'white' }}  onHide={() => onHide('displayBasic2')}>
                    ...
                    <div className="p-grid" style={{ width: '102%'}}>
                        ...
                        <div className="p-col-4">
                            <Link to="/estimate-reference-report" className="Link" onHide={() => onHide('displayBasic')}>
