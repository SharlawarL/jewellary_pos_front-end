...
export default function DataTableFilterDemo(props) {
    ...
    const rowClass = (data) => {
        return {
            'row-accessories': data.ino === 'Total'
        }
    }
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Estimate Summary</h3>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '100%', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock} className="p-datatable-striped" globalFilter={globalFilter} emptyMessage="No Search Result." rowClassName={rowClass}>
                                    ...
                                    <Column field="iname"  header="Item Name" />
                                    <Column field="quan"       style={{ textAlign:'centetr' }} header="Qty" />
                                    <Column field="amount"     style={{ textAlign:'right',width: '200px' }} header="Amount" />
                                    <Column field="category"       style={{ textAlign:'centetr' }} header="Category" />
                                    <Column field="item_type"       style={{ textAlign:'centetr' }} header="Item Type" />
                                </DataTable>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-grid" style={{ padding: '10px 15px' }}>
                    ...
                    <div className="p-col-1 submitFormButton">
                        <Link to="/estimate-summary-report" className="Link">
