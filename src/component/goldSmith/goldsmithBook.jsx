        ...
        return (
            <div className="body">
                ...
                <div className="button_box_small_title">
                    <h3 className="pageTitle">Gold Smith Book </h3>
                </div>
                <div className="continerSmallBox"> 
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                ...
                                <Dropdown style={{width:'100%'}} value={this.state.gname} options={this.state.gnameList} onChange={(e) => this.setState({ gname: e.value })} optionLabel="name" placeholder="Select Gold Smith" />
                            </div>
                        </div>
                        <br></br>
                        <br></br>
                ...
                <div className="button_box_small">
                    <div className="row">
                        ...
                        <Link 
                            to={{
                                pathname: (this.state.from && this.state.to && this.state.gname.gname) ? "/gold-smith-book-print" : '/gold-smith-book',
                                state: {
                                    from: this.state.from,
                                    to : this.state.to,
                                    gname : this.state.gname.gname
                                }
                            }}
                            className="Link">
