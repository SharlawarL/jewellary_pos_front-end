...
export default class orderEntryComponent extends Component {
    ...
    getSupplierLast() {
        ...
        goldsmithService.getSmithIssueLast(data).then((response) =>{
    ...
    submitForm(e) {
        ...
        goldsmithService.smithReceiptEntry(data).then((response) => {
            if (response['data']['status'] === 1) {
            ...
            <div className="body">
                ...
                <form onSubmit={this.submitForm} autoComplete="off">
                    <div className="button_box_small_title">
                        <h3 className="pageTitle">GOLD Smith Issue Entry</h3>
                    </div>
