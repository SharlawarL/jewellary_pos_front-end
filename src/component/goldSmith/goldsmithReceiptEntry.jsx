...
export default class orderEntryComponent extends Component {
    ...
    getSupplierLast() {
        ...
        goldsmithService.getSmithReceiptLast(data).then((response) =>{
    ...
    getSupplier() {
        ...
        goldsmithService.getSmith(data).then((response) =>{
    ...
    submitForm(e) {
        ...
        goldsmithService.smithIssueEntry(data).then((response) => {
            if (response['data']['status'] === 1) {
            ...
            <div className="body">
                ...
                <form onSubmit={this.submitForm} autoComplete="off">
                    <div className="button_box_small_title">
                        <h3 className="pageTitle">GOLD Smith Receipt Entry</h3>
                    </div>
                    ...
                    <div className="p-grid">
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                <div style={fontLebel}>Gold Smith Name</div>
                                
                                <div style={{width:'100%'}}>
                                <input list="browsers" placeholder="Enter Gold Smith Name" style={{width:'100%',border:'1px solid silver',outline:'1px solid #ced4da',borderRadius:'3px',padding:'10px 10px'}} id="browser" name="supplier" value={this.state.supplier}  onChange={this.onChange} />
                                <datalist id="browsers" >
                                    {  
                                        this.state.supplierList.map((item,index)=>{
                                            return  <option key={index} value={item.gname} />;
                                        })
                                    }
                                </datalist>
