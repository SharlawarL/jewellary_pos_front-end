            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Items List</h3>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', marginTop:'10px', overflowX: 'scroll' }}>
                            <div style={{ width: '1500px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock} className="p-datatable-striped" globalFilter={globalFilter} emptyMessage="No Search Result." rowClassName={rowClass}>
                                    <Column field="grn"  header="Item Code" />
                                    <Column field="bdate"  header="Item Name" />
                                    <Column field="billno"  header="Category" />
                                    <Column field="bdate"  header="Item type" />
                                    <Column field="pby"  header="Purity" />
                                    <Column field="pby"  header="Making Charges" />
                                    <Column field="pby"  header="Wastage%" />
                                    <Column field="pby"  header="Location" />
                                    <Column field="pby"  header="HSN Code" />
                                    <Column field="pby"  header="Price Type" />
                                </DataTable>
                            </div>
                        </div>
                    </div>
