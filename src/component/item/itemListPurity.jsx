        ...
        itemService.getDropItem(data).then((response) =>{
            ...
            if (response['data']['status'] === 1) {
                response['data']['data'].map((data) =>{
                    return(
                    data['label'] = data['purity'],
                    data['value'] = data['purity'])
                    })
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Purity Wise Items List</h3>
                        <div className="p-grid-data">
                            ...
                            <div style={{ padding: '10px 20px'}}>
                                <div className="p-field">
                                    <label htmlFor="username1" className="p-d-block" style={lebelStyle}><input type="checkbox" name="check" id="username1" style={{verticalAlign:"text-top"}} value={checkBox} onClick={()=> setCheckBox(!checkBox)}></input>  Select All </label>
                                </div>
                            </div>
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', marginTop:'10px', overflowX: 'scroll' }}>
                            <div style={{ width: '1900px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock} className="p-datatable-striped" globalFilter={globalFilter} emptyMessage="No Search Result." rowClassName={rowClass} selectionMode="single" onSelectionChange={e => clickRow(e.value)}>
                ...
                <div className="p-col-7 submitFormButton"></div>
                    ...
                    <div className="p-col-1 submitFormButton">
                        <Link to="/item-purity-list" className="Link">
