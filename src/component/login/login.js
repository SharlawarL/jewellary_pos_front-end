...
import Vector from '../../assets/img/img-10.gif';
    ...
    submitForm(e) {
        ...
        userService.userLogin(data).then((response) => {
            ...
            if (response['data']['status'] === 1) {
                ...
                localStorage.setItem("loginType", "EmployeeLogin")
                localStorage.setItem("user", JSON.stringify(response['data']['data'][0]))
                localStorage.setItem("userlevel", response['data']['data'][0]['user_level']?response['data']['data'][0]['user_level']:0)
                localStorage.setItem("role", "Administrator")
                localStorage.setItem("Branch", response['data']['data'][0]['branch']?response['data']['data'][0]['branch']:0)
                        ...
                        <form className="FormBox" onSubmit={this.submitForm} autoComplete="off">
                            ...
                            <div className="logiInputBox">
                                <div className="formInput">
                                    <Input className="loginInputBox login-input" style={{border:'none', padding:'5px 20px', borderRadius:'20px',backgroundColor:'rgba(245, 236, 235,0.5)'}}
                                ...
                                <div className="formInput">
                                    ...
                                    <PasswordField className="loginInputBox login-input"
                                ...
                                <div className="formInput">
                                    <Button type="submit" className="inputData buttonPrimaryLogin"  variant="contained" color="primary">
                                        <div className="buttonText" style={{ color: 'white', fontWeight:'300' }}><span className="buttonTextFirstLetter" >L</span>ogin</div>
                                    </Button>
                                </div>
                                <div className="formInput hoLogin">
                                    <Button className="inputData buttonSecondaryLogin"  variant="contained" color="primary">
                                        <Link to="/headOfficeLogin" className="Link" >
                                            <div className="buttonText" style={{ color: 'black', fontWeight:'300' }}><span style={{textTransform:'uppercase'}}>H</span>ead <span style={{textTransform:'uppercase'}}>O</span>ffice <span style={{textTransform:'uppercase'}}>L</span>ogin </div>
                                        </Link>
                                    </Button>
                                </div>
                                <div className="formInput">
