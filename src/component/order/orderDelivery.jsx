...
export default class orderEntryComponent extends Component {
    ...
    onChangeLotNumber(e) {
        ...
        for (let data of this.state.order_List) {
            console.log(count)
            if (data.sno === e.target.value){
                count++
                this.setState({
                    order_type:{ name:data.otype, code:data.otype},
                    order_date: data.dat,
                    mobile: data.mobile,
                    ...
                    paid_amt: data.paid,
                    blc_amt: data.bal,
                    delivery_date: data.ddate,
                    payment_mode: data.pby,
                    remark: data.remarks,
                })
    ...
    getSchema() {
        ...
        schemaService.getOrder(data).then((response) => {
    ...
    submitForm(e) {
        ...
        let data = {
            ...
            total:total?total:'0',
            dis_amt:dis_amt?dis_amt:0,
            other_amt:other_amt?other_amt:0,
            net : total_amt + other_amt - dis_amt - paid_amt,
            remark : remark
        }

        console.log(data)

        schemaService.saveOrderDelivery(data).then((response) => {
            if (response['data']['status'] === 1) {
            ...
            <div className="body">
                ...
                <form onSubmit={this.submitForm} autoComplete="off">
                    <div className="button_box_small_title">
                        <h3 className="pageTitle">Order Delivery </h3>
                    </div>
                    ...
                    <div className="continerSmallBox">
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                <div style={fontLebel}>Order Number</div>
                                <div style={{ width: '100%' }}>
                                    <input list="orderNumber" placeholder="Enter Order Number" style={{ width: '100%', border: '1px solid silver', borderRadius: '3px', padding: '10px 10px' }} name="order_number" id="browser" value={this.state.order_number} onChange={this.onChangeLotNumber} />
                                    <datalist id="orderNumber" >
                                        {
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                ...
                                <div style={{width:'100%'}}>
                                <InputText type="date" id="username1" aria-describedby="username1-help" style={{ width: '100%' }} name="order_date" value={this.state.order_date} onChange={this.onChangeLotNumber} />
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                ...
                                <div style={{width:'100%'}}>
                                <InputText type="date" id="username1" aria-describedby="username1-help" style={{ width: '100%' }} name="delivery_date" value={this.state.delivery_date} onChange={this.onChangeLotNumber} />
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                <div style={fontLebel}>Other Charges</div>
                                
                                <div style={{width:'100%'}}>
                                <InputText id="username1" placeholder="Enter Other Charges" aria-describedby="username1-help" style={{ width: '100%' }} name="other_amt" value={this.state.other_amt} onChange={this.onChange} />
                                    {/* <div className="textDanger">{this.state.errors.total_amt}</div> */}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                <div style={fontLebel}>Discount Amount</div>
                                
                                <div style={{width:'100%'}}>
                                    <InputText id="username1" placeholder="Enter Total Amount" aria-describedby="username1-help" style={{ width: '100%' }} name="dis_amt" value={this.state.dis_amt} onChange={this.onChange} />
                                    {/* <div className="textDanger">{this.state.errors.total_amt}</div> */}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                ...
                                <div style={{width:'100%'}}>
                                <InputText id="username1" placeholder="Enter Balance Amount" aria-describedby="username1-help" style={{ width: '100%' }} name="total" value={(parseFloat(this.state.total_amt) + parseFloat(this.state.other_amt)) - parseFloat(this.state.dis_amt) - parseFloat(this.state.paid_amt)} onChange={this.onChange} />
