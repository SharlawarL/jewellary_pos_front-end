                    ...
                    <div className="continerPrintInvoiceBox card-box">
                        <div style={{ padding: '30px 10px' }} ref={el => (this.componentRef = el)}>
                            <div className="content">
                                ...
                                <hr></hr>
                                <h3 style={{textAlign:'center'}}> {this.state.back == '/issue-to-menu'?'DELIVERY CHALLAN - JOB WORK':'JOB WORK LABOUR BILL'}</h3>
                                <hr></hr>
                                <div className="row">
                                    <div className="col-6">
                                ...
                                <table style={{ width: '100%', marginTop: '10px' }}>
                                    <tr className="heading">
                                        ...
                                        <th style={{ textAlign: 'center', border: '2px solid black'}}>Stone</th>
                                        <th style={{ textAlign: 'center', border: '2px solid black'}}>Total Weight</th>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>{this.state.data['stone']}</td>
                                        <td style={{ borderLeft: '2px solid black',borderRight: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>{this.state.data['weight']}</td>
                                    </tr>
                                    <tr>
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>2</td>
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>Alloy</td>
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>{this.state.data['alloyhsn']}</td>
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>{this.state.data['alloywt']}</td>
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}></td>
                                        <td style={{ borderLeft: '2px solid black',borderRight: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>{this.state.data['alloywt']}</td>
                                    </tr>
                                    <tr>
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}></td>
                                        <td style={{ borderLeft: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ borderLeft: '2px solid black',borderBottom: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}></td>
                                        <td style={{ borderLeft: '2px solid black',borderBottom: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}></td>
                                        <td style={{ borderLeft: '2px solid black',borderBottom: '2px solid black',textAlign: 'center' ,padding:'6px 0px' }}>Total</td>
