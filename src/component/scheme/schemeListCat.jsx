            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Category Wise Schemes List</h3>
                        <div className="p-grid-data">
                            ...
                            <div className="column-input" style={{ width: '215px' }}>
                                <div className="p-field">
                                <Dropdown value={customer} options={cat} onChange={(e) => setCustomer(e.value)} optionLabel="name" placeholder="Select a Category" />
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '100%', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock}  rowClassName={rowClass} selectionMode="single"
                                    ...
                                    <Column field="category"      style={{ width: '120px' }} header="Category" />
                                    <Column field="sname"     style={{ width: '300px',textAlign:'left' }} header="Scheme Name" />
                                    <Column field="due"      style={{ width: '120px',textAlign:'right' }}   header="Dues Amount" />
                                    <Column field="months"      style={{ width: '120px',textAlign:'right' }}   header="Total Dues" />
                                </DataTable>
                            </div>
                        </div>
                    </div>
