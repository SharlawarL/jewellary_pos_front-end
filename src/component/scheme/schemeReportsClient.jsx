...
export default function DataTableFilterDemo(props) {
    ...
    const getDateItem = () => {
        ...
        let data = {
            ...
            drop: customer?customer.name:'',
            type: 'scheme-report-client',
        }
    ...
    const getDropDown = () => {
        ...
        schemaService.getSchemaReportsDrop(data).then((response) => {
            console.log(response)
            if (response['data']['status'] === 1) {
                response['data']['data'].map( data =>{
                    data['name'] = data['aname']
                })
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Client Wise Scheme Report</h3>
                        <div className="p-grid-data">
                            ...
                            <div style={{ padding: '10px 10px',width:'100px', textAlign: "right" }}>
                                <div className="p-field">
                                    <label htmlFor="username1" className="p-d-block" style={lebelStyle}>Client </label>
                                </div>
                            </div>
                            <div className="column-input" style={{ width: '215px' }}>
                                <div className="p-field">
                                <Dropdown value={customer} options={cat} onChange={(e) => setCustomer(e.value)} optionLabel="name" placeholder="Select a Customer" />
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '3500px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock}  rowClassName={rowClass} selectionMode="single"
                                    ...
                                    <Column field="sno"      style={{ width: '120px' }} header="Scheme No" />
                                    <Column field="dat"      style={{ width: '120px' }}   header="Date" />
                                    <Column field="sname"     style={{ width: '300px',textAlign:'left' }} header="Scheme Name" />
                                    <Column field="category"       style={{ width: '150px',textAlign:'left' }} header="Category" />
                                    <Column field="cid"       style={{ width: '150px',textAlign:'left' }} header="Cust Id" />
                                    <Column field="cname"     style={{ width: '150px',textAlign:'left' }} header="Cust Name" />
                                    <Column field="mobile"     style={{ width: '150px',textAlign:'left' }} header="Mobile" />
                                    <Column field="due_amount"   style={{ width: '150px',textAlign:'right' }} header="Due Amount" />
                                    <Column field="dues"        style={{ width: '200px',textAlign:'right' }} header="Dues" />
                                    <Column field="paid"     style={{ width: '150px',textAlign:'right' }} header="Paid" />
                                    <Column field="paid_dues"     style={{ width: '150px',textAlign:'right' }} header="Paid Dues" />
                                    <Column field="total"     style={{ width: '150px',textAlign:'right' }} header="Total" />
                                    <Column field="weight"   style={{ width: '200px',textAlign:'right' }} header="weight" />
                                    <Column field="acode"     style={{ width: '200px',textAlign:'left' }} header="Client Code" />
                                    <Column field="aname"   style={{ width: '200px' ,textAlign:'left' }} header="Client Name" />
                                    <Column field="remarks"          header="Remarks" />
                                    <Column field="STATUS"      style={{ width: '200px' ,textAlign:'left' }}   header="STATUS" />
                                </DataTable>
                            </div>
                        </div>
                    </div>
