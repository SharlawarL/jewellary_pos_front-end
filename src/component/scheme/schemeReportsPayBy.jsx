            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Paymode Wise Payments Report</h3>
                        <div className="p-grid-data">
                            ...
                            <div style={{ padding: '10px 10px',width:'100px', textAlign: "right" }}>
                                <div className="p-field">
                                    <label htmlFor="username1" className="p-d-block" style={lebelStyle}>Pay By </label>
                                </div>
                            </div>
                            <div className="column-input" style={{ width: '215px' }}>
                                <div className="p-field">
                                <Dropdown value={customer} options={cat} onChange={(e) => setCustomer(e.value)} optionLabel="name" placeholder="Select a Pay" />
