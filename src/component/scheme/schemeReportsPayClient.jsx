            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Client Wise Scheme Payments Report</h3>
                        <div className="p-grid-data">
                            ...
                            <div className="column-input" style={{ width: '215px' }}>
                                <div className="p-field">
                                <Dropdown value={customer} options={cat} onChange={(e) => setCustomer(e.value)} optionLabel="name" placeholder="Select a Client" />
                        ...
                        <div style={{ height: '50vh', border: '1px solid #227bce', overflowX: 'scroll' }}>
                            <div style={{ width: '2000px', marginTop: '-5px' }}>
                                <DataTable ref={dt} value={stock}  rowClassName={rowClass} selectionMode="single"
                                    ...
                                    <Column field="billno"      style={{ width: '120px' }} header="Receipt No" />
                                    ...
                                    <Column field="dues"   style={{ width: '150px',textAlign:'right' }} header="No of Dues" />
                                    <Column field="amount"     style={{ width: '150px',textAlign:'right' }} header="Paid Amount" />
                                    <Column field="pby"     style={{ width: '150px',textAlign:'right' }} header="Pay Mode" />
