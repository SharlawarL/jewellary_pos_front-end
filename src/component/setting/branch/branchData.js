...
//service 
import BranchService from '../../../service/setting/branchService'
...
export default function DataTableFilterDemo(){
  ...
  const saveAsExcelFile = (buffer, fileName) => {
    ...
    const handleDelete = () => {
      ...
      let data = {username : localStorage.getItem("username"), branch : branch}
      branchService.deleteBranch(data).then((response) =>{
    ...
    const getItem = () => {
        ...
        branchService.getBranch(data).then((response) =>{
          if(response['data']['status'] ===1)
              {
            ...
            <div className="p-grid">
                  ...
                  <div className="p-col-3">
                      <Link to="/addbranch" className="Link" >
                              <Button label="New Branch" icon="pi pi-plus-circle"/>
                        </Link>
                  </div>
              </div>
                ...
                <DataTable ref={dt} value={stock} paginator rows={4}
                    ...
                    <Column field="sr_no" header="Sr No"  style={{width:'150px'}}/>
                    <Column field="branch" header="Branch" style={{width:'400px'}} />
