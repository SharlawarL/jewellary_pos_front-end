...
export default class stockComponent extends Component {
    ...
    getTotalBranch()
    {
      ...
      submitForm(e){
        ...
        if(this.validate()){
            ...
            userService.saveAdminUser(data).then((response) =>{
                if(response['data']['status'] === 1)
                {
    ...
    render(){
        ...
        {
            return <Redirect to='/headuser-list'></Redirect>
        }
        ...
        return(
            <div className="body">
                ...
                <div className="button_box_small_title">
                    <h3 className="pageTitle">Head Office User Master</h3>
                </div>
                <div className="continerSmallBox">
                        ...
                        {/* <div className="row">
                            ...
                            <div className="col-6">
                                <Link to="/headusermaster" className="Link">
