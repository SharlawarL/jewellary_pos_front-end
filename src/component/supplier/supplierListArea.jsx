...
export default function DataTableFilterDemo(props) {
    ...
    const getItem = () => {
        ...
        supplierService.getDropSupplier(data).then((response) =>{
    ...
    const getDateItem = () => {
        ...
        supplierService.getSupplier(data).then((response) =>{
            ...
            if (response['data']['status'] === 1) {
                ...
                let tdata = { cname:'Total',
                                add1 : response['data']['data'].length,
                            }
    ...
    const rowClass = (data) => {
        return {
            'row-accessories': data.cname === 'Total'
        }
    }
            ...
            <div className="continerPonitBox">
                ...
                <div className="datatable-filter-demo">
                    <div className="card" style={{ width: '100%', padding: '10px 10px' }}>
                        <h3 style={{ margin: '0px 0px 15px' }}>Area Wise Suppliers List</h3>
